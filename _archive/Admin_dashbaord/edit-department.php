...
$id = $_GET['id'];
$fetch_query = mysqli_query($conn, "select * from vms_department where id='$id'");
...
if(isset($_REQUEST['sv-dpt']))
{
  ...
  $update_department = mysqli_query($conn,"update vms_department set department='$department_name', status='$status' where id='$id'");
