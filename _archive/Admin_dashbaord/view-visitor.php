...
// Fetch event name
$event = mysqli_fetch_assoc(mysqli_query($conn, "SELECT event_name FROM vms_events WHERE event_id = $event_id"));
$event_name = $event['event_name'] ?? "Unknown Event";

// Fetch visitors
$visitors = mysqli_query($conn, "SELECT * FROM vms_visitors WHERE event_id = $event_id");
?>
<!DOCTYPE html>
<html>
<head>
